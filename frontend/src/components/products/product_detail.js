          ...
          >
            ...
            <div className="miw-lg:w-1/2 mw-md:w-1/2 mw-md:h-auto flex flex-col justify-around p-4 bg-gray-200 rounded">
              ...
              <div className="flex justify-end mt-3 mw-md:flex-col mw-md:text-nowrap mw-md:mt-2">
                ...
                <span className="text-center text-nowrap mw-xl:px-2 mw-xl:text-[0.6rem] mw-3xl:px-4 mw-3xl:text-[0.75rem] py-2 mx-2 mw-md:mb-2 bg-black hover:bg-black/70 trasition-all duration-150 text-white font-bold rounded cursor-pointer mw-md:text-[0.6rem] ">
