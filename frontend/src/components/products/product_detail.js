...
export const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    console.log('fetchStars: ', fetchStars);
  ...
  // 유저가 현재 상품에 대해서 이미 리뷰가 작성되어있는 경우 보여줄 컴포넌트 그리고 edit 버튼 클릭해서 별점과 텍스트 수정 가능
          ...
          <div id="product_info" className="w-[60%] mw-md:w-[80%] h-3/5 mt-10 my-auto flex justify-between">
            ...
            <div className="miw-lg:w-1/2 mw-md:w-1/2 mw-md:h-auto flex flex-col justify-around p-4 bg-gray-200 rounded">
              ...
              <div className="flex justify-end mt-3 mw-md:flex-col mw-md:text-nowrap mw-md:mt-2">
                <span
                  className="text-center miw-lg:px-5 py-2 mx-2 mw-md:mb-2 flex justify-center items-center bg-blue-500 hover:bg-blue-600 trasition-all duration-150 rounded cursor-pointer"
                ...
                >
                  ...
                  />
                  <b className="text-white miw-lg:text-sm mw-md:text-[0.6rem]">좋아요</b>
                </span>
                <span className="text-center miw-lg:px-5 py-2 mx-2 miw-lg:text-sm mw-md:mb-2 bg-black hover:bg-black/70 trasition-all duration-150 text-white font-bold rounded cursor-pointer mw-md:text-[0.6rem] ">
                  <FontAwesomeIcon icon={faMoneyBillWave} className="mr-1" />
                  <b>구매하기</b>
                </span>
                <span className="text-center miw-lg:px-5 mw-md:w-20 py-2 mx-2 miw-lg:text-sm mw-md:mb-2 mw-md:flex mw-md:justify-center mw-md:items-center bg-green-600 hover:bg-green-700 trasition-all duration-150 rounded cursor-pointer mw-md:text-[0.6rem]">
  ...
  return (
    <>
      <div
        ...
        className="w-[90%] mw-md:w-full h-full mt-10 border border-gray-300"
      >
        <ItemInfo />
