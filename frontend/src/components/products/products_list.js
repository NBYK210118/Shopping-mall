...
export function Products() {
  const { token, user, setUser, category, setCategory, setLoading, navigate } =
        ...
        return (
          <Link to={`/products/${val.id}`} key={val.id}>
            ...
            >
              ...
              <h3 className="font-bold text-md mw-md:text-sm mb-1">
                {val.name}
              </h3>
              <p className="text-sm mw-md:text-xs mb-2">
  ...
  return (
    <div id="products_main" className="w-[100%] h-[100%] flex justify-center">
      <div
        ...
        className="w-[100%] h-[100%] absolute top-20 mw-md:top-16"
      >
