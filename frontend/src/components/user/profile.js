...
export default function UserProfile(props) {
  ...
  const [nickname, setNickname] = useState(
    `(${user["profile"] ? user["profile"]["nickname"] : "Not yet"}`
  );
  const [address, setAddress] = useState(
    `(${user["profile"] ? user["profile"]["address"] : "None"}`
  );
      ...
      <div className="flex flex-row items-center w-full h-full">
        <div className="w-[50%] h-full flex flex-col justify-center">
          ...
          >
            <div
              id="profile_image"
              className={`w-[40%] flex justify-center mr-3 ${
                imageUrl ? " hidden" : ""
              }`}
            >
              <img
                src={Images.Profile}
                alt="profile_img"
                className={`w-[75%] h-[55%] opacity-[4]`}
              />
            </div>
            <div
              className={`w-[55%] h-[120%] flex justify-center items-center mr-3 ${
                imageUrl ? "" : " hidden"
              }`}
            >
              <img
            ...
            <div className="w-[60%] h-[80%] flex flex-col justify-around items-center">
              ...
              >
                ...
                >
                  <span
                    className={`font-bold ml-3 text-xl ${
                      editClick ? " hidden" : ""
                    }`}
                  >
                ...
                >
                  <img
                    src={Images.Edit}
                    alt=""
                    className={`p-2 border-transparent rounded-lg hover:cursor-pointer bg-sky-500 ${
                      editClick ? " hidden" : ""
                    } hover:bg-sky-600`}
                  />
                </div>
          ...
          >
            <div className="w-[80%] h-full mt-10 flex justify-around items-around">
              ...
              <div
                id="labels_col"
                className="w-full h-[85%] flex flex-col justify-around"
              >
                ...
                <div className="w-full h-[10%] flex justify-center">
                  ...
                  <div className="w-[70%] mt-1">
                    {userInfo ? (
                      ...
                      <span
                        className={`${
                          user["profile"]["address"].length > 20
                            ? "text-[15px]"
                            : "text-[18px]"
                        }`}
                      >
                ...
                <div
                  id="edit_button_div"
                  className="w-full h-[15%] mt-5 flex justify-center"
                >
                  {userInfo ? (
                    <div
