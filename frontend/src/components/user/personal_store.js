...
export default function PersonalStore() {
  ...
  return (
    <div
      className={`w-full h-full miw-lg:mt-14 flex justify-center items-center border border-gray-300 rounded-lg`}
    >
      <div
          ...
          {!activeOption && (
            <>
              ...
              <div className="w-full h-full flex flex-col justify-center">
                <div className="miw-lg:p-5 miw-lg:my-10 w-full h-[35%] p-5 flex justify-between items-center">
                  ...
                  {manageProduct ? (
                    ...
                    >
                      ...
                      <div
                        ...
                        } h-2/3 mw-md:w-1/2 miw-lg:p-3 flex justify-center items-center border border-transparent rounded-lg bg-green-600 hover:cursor-pointer hover:bg-green-700`}
                      >
