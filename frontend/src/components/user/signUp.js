      ...
      >
        <div className="w-full h-[39%] flex justify-center">
          <img
            src={Images.logo}
            alt="Logo"
            className="w-[55%] h-full border border-transparent rounded-xl"
          />
        </div>
        <div className="w-[55%] h-[75%] flex justify-center">
          <div
            id="label_input_group"
            className="w-[95%] flex flex-col justify-around"
          >
            ...
            <div className="w-full flex flex-row justify-center">
              ...
              >
                ...
                >
                  <span className="text-white font-bold hover:cursor-pointer">
                    Sign In
                  </span>
                </div>
              </div>
