  ...
  return (
    <div className="">
      ...
      {isOpenModal && (
        <div
          id="modal-container"
          className="fixed inset-0 bg-black/50 z-50 flex justify-around items-center"
        >
          <div
            id="modal"
            className="w-[25%] h-[75%] p-3 bg-white rounded-lg shadow-custom"
          >
            <div
              className="w-[100%] h-[9%] flex justify-end cursor-pointer p-2 mb-1"
            ...
            <form
              ...
              className="h-[40%] flex flex-col justify-around ml-2"
            >
              <div className="">
