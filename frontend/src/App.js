  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="mw-md:ml-5 relative miw-md:w-[150px] h-full flex justify-between"
      >
      ...
      <div
        id="search-box"
        className={`w-[650px] h-full ml-24 mw-md:3/4 mw-md:-ml-9 flex justify-center items-center`}
      >
...
function App() {
  ...
  return (
    <div className={`w-[100vw] h-full overflow-hidden`} id="main">
      {loading && <Loading />}
      <MainHeader />
